...
class Registrations
{
  public static function create()
  {
    $email = new Email();
    $allowed_servers = [
      "https://ribkavyvoj.kvalitne.cz/akce",
      "https://kromland.cz/akce",
    ];
    ...
    try {
      ...
      $first_representative_name = $registrationData->first_representative_name;
      ...
      $email->sendInternally($user_email, "Potvrzení registrace", $email_body);
